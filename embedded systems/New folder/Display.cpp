...
public void DisplayHardware::writeByte(uint8_t data)
{
...
public void DisplayHardware::showRaw(uint8_t digitPos, uint8_t segmentcode)
{
...
public void DisplayHardware::showCharAt(uint8_t digitPos, char letter)
{
...
public void DisplayHardware::showDigitAt(uint8_t digitPos, uint8_t digit, bool showDot)
{
...
public void DisplayHardware::show(float value)
{
...
public void DisplayHardware::show(int value)
{
    int pos = NUM_DIGITS - 1;
...
public void DisplayHardware::show(const char data[])
{
...
public void DisplayHardware::clear()
{
    showRaw(0x00, 0x7f);
    showRaw(0x01, 0x7f);
    showRaw(0x02, 0x7f);
...
public void DisplayHardware::start()
{
    pinMode(_dataPin, OUTPUT);
    bitDelay();
}
//End of transmission
public void DisplayHardware::stop()
{
    pinMode(_dataPin, OUTPUT);
    bitDelay();
    pinMode(_clockPin, INPUT);
...
public void DisplayHardware::bitDelay()
{
