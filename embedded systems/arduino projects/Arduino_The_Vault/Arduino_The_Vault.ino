...
//By Valentin Vasilev PC05 |||||| Code in pastebin - https://pastebin.com/vtTk6yGz
...
Display.show("    ");
//Display.showRaw(0, 0x4B);                  //I clear the Display every time I upload the code, since for some reason this is not included in the Library...
}
